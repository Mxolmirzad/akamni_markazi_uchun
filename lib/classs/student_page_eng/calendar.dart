  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          "${today.day}.${today.month}.${today.year} list of lessons for the day",
          style: TextStyle(
            fontSize: 20.0,
            color: Colors.black,
          ),
        ...
        child: Column(
          children: [
            ListTile(
              ...
              title: Text(
                "There is an English class at 4:00 p.m",
                style: TextStyle(fontSize: 20.0, color: Colors.black),
              ),
              subtitle: Text(
                "Teacher: Palonchiev Pistonchi",
            ...
            ListTile(
              ...
              title: Text(
                "There is a Russian language lesson at 2:00 p.m",
                style: TextStyle(fontSize: 20.0, color: Colors.black),
              ),
              subtitle: Text(
                "Teacher: Palonchiev Pistonchi",
